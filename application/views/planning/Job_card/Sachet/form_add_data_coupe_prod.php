...
<fieldset class="col-md-12 border text-left text-blue">
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input type="text" name="machine" disabled value="<?= $machine ?>" class="form-control form-control-sm" id="machine">
        </div>
        <div class="form-group col-md-6">
            <label for="JO_ID">N° Job card : </label>
            <input type="text" name="JO_ID" disabled value="<?= $id_job ?>" class="form-control form-control-sm" id="id_jobs">
        </div>
    </div>
</fieldset>
<fieldset class="col-md-12 border text-left mt-2 text-blue">
    <div class="row">
        ...
        <div class="form-group col-md-4">
            <label for="quantite">Pièces à produire : </label>
