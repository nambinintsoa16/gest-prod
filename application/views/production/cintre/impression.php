...
<div class="row">
	<div class="form-control text-left col-md-12 w-100">
		<div class="row">
			<div class="col-md-2">
				<a href="#" class="btn btn-primary btn-sm" id="show_modal"><i class="icon-plus"></i>&nbsp;INPRESSION</a>
			</div>
...
<div class="modal fade" id="modal_form_cintre_impression" tabindex="-1" role="dialog" aria-labelledby="modal_form" aria-hidden="true">
