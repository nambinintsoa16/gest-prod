...
<div class="row">
	<div class="form-control text-left col-md-12 w-100">
		<div class="row">
			<div class="col-md-2">
				<a href="#" class="btn btn-primary btn-sm" id="show_modal_form"><i
						class="icon-plus"></i>&nbsp;INJECTION</a>
			</div>
			<div class="col-md-10 text-rigth">
				<div class="row">
					<div class="col-md-4">
						<select class="form-control form-control-sm" id="Quart_show">
                            <option value=""></option>
					...
					<div class="col-md-4">
						<input type="text" class="form-control w-100 form-control-sm " id="Operateur_show" placeholder="Chef d'équipe">
					</div>
					<div class="col-md-4">
					...
					<div class="col-md-4 mt-2">
						<a href="#" class="btn btn-info btn-sm" id="show_data"><i
								class="fa fa-tv"></i>&nbsp;Afficher</a>
					</div>
				</div>
			</div>
		</div>
...
<div class="modal fade" id="modal_form_injection" tabindex="-1" role="dialog" aria-labelledby="modal_form"
	aria-hidden="true">
					...
					<div class="container text-left">
						<div class="row">
							...
							<div class="form-group col-md-4">
								<label for="">PO</label>
								<input type="text" name="BC_PO" id="BC_PO"
									class="form-control form-control-sm refnum_commande">
							</div>
							<div class="form-group col-md-4">
							...
							<div class="form-group col-md-4">
								...
								<input type="text" name="IN_REFERENCE" id="IN_REFERENCE"
							...
							<div class="form-group col-md-4">
								...
								<input type="text" name="IN_DECHETS" id="IN_DECHETS"
									class="form-control form-control-sm">
							</div>
							...
							<div class="form-group col-md-4">
								...
								<input type="text" name="IN_OPERATEUR1" id="IN_OPERATEUR1"
									class="form-control form-control-sm operateur">
							</div>
							<div class="form-group col-md-4">
								<label for="">OPERATEUR 2</label>
								<input type="text" name="IN_OPERATEUR2" id="IN_OPERATEUR2"
									class="form-control form-control-sm operateur">
							</div>
							<div class="form-group col-md-4">
								<label for="">MATIERES EN(kg)</label>
								<input type="text" name="IN_MATIERES" id="IN_MATIERES"
									class="form-control form-control-sm">
							</div>
							<div class="form-group col-md-4">
								<label for="">MASTER BATCHE</label>
								<input type="text" name="IN_MASTERBATCHE" id="IN_MASTERBATCHE"
									class="form-control form-control-sm">
							</div>
