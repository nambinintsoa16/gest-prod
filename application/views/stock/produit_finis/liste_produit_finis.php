...
<fieldset class="col-md-12 border mt-2 w-100 pt-3 bg-white">
    <table class=" table-sm table-bordered table-hover table-strepted w-100" id="table_produit_fini">
...
<div class="modal fade bd-example-modal-lg" id="modal_detail_produit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
