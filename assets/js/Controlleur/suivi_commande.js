$(document).ready(function() {
    let table = $("#table-suivi").DataTable({
        ajax: base_url + "controlleur/data_list_suivi_commande",
        processing: true,
        language: {
    ...
    $("#show_data").on("click", function(event) {
        ...
        let debut = $("#debut").val();
        let fin = $("#fin").val();
        let link = base_url + "controlleur/data_list_suivi_commande?debut=" + debut + "&fin=" + fin;
        table.ajax.url(link);
        table.ajax.reload();
    });
