$(document).ready(function() {
    let date_commande = $('#date_commande').text();
    table = $("#table_non_planifier").DataTable({
        processing: true,
        ajax: base_url + "Planning/liste_commande_sachet_all_champ?date="+date_commande,
        language: {
    ...
    $("#valide_search").on("click", function(event) {
    ...
    function chargement() {
        var htmls =
            '<style> .spinner div{background-color:#ffad46;}</style><div class="text-center" style="font-size:14px;"><span class="text-center">Traitement en cours ...</span></div><div class="spinner"><div class="rect1"></div><div class="rect2"></div><div class="rect3"></div><div class="rect4"></div><div class="rect5"></div></div>';
        $.dialog({
            title: "",
            content: htmls,
            show: true,
